...
export default function Post({
  ...
  async function editComment(commentId: number) {
    if (updateComment !== "") {
      ...
      if (resultIllegalContent !== -1) {
        setIllegalContentMessage(
          "In deinen Kommentar wurde problematischer Inhalt gefunden. Bitte überprüfe und korrigiere ihns."
        );
        setIllegalContentPopUp(true);
      } else {
    ...
    <>
      ...
      <Dialog open={commentPopUp} onOpenChange={setCommentPopUp}>
        <DialogContent
          ...
          className=""
        >
          <DialogHeader className="h-[800px] px-3 border border-gray-400 rounded-sm overflow-y-scroll">
            <div className="">
              {commentsArray
          ...
          <DialogDescription className="flex justify-end items-center gap-x-3">
            {" "}
            <button
              onClick={() => {
                loadCommentCounts();
              ...
              className="px-3 py-1.5 text-[16px] text-black flex justify-center items-center gap-x-1 bg-gray-50 border border-gray-200 rounded-sm cursor-pointer hover:bg-white"
            >
              <svg
            ...
            <button
              ...
              className="px-5 py-1.5 text-[16px] flex justify-center items-center gap-x-1 bg-blue-400 text-white border border-white rounded-sm cursor-pointer hover:bg-white hover:text-blue-400 hover:border-blue-400"
            >
      ...
      <Dialog open={createCommentPopUp} onOpenChange={setCreateCommentPopUp}>
        <DialogContent
          ...
          className=""
        >
          <DialogDescription className="p-3 flex flex-col items-center justify-center gap-y-5">
            <textarea
              value={createComment}
              onChange={(event) => {
                editCreateCommentInput(event.target.value);
              }}
              className="w-full h-[250px] text-black text-lg px-5 py-3 resize-none"
              name=""
            ></textarea>

            <div className="w-full pt-1 flex justify-end items-center gap-x-3">
              <button
                onClick={() => {
                  loadComments();
                  setCreateComment("");
                ...
                className="px-3 py-1.5 text-[16px] text-black flex justify-center items-center bg-gray-50 border border-gray-200 rounded-sm cursor-pointer hover:bg-white"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
              ...
              <button
                ...
                className={`px-5 py-1.5 text-[16px] flex justify-center items-center gap-x-1 ${
                  checkTextContent
                    ? "bg-blue-400 text-white border border-white rounded-sm cursor-pointer hover:bg-white hover:text-blue-400 hover:border-blue-400"
                    : "bg-gray-200"
                }`}
              >
                {" "}
        ...
        >
          ...
          <DialogClose className="flex justify-end items-center gap-x-3">
            ...
            <button
              ...
              className="px-3 py-1.5 flex justify-center items-center gap-x-1 bg-gray-50 border border-gray-200 cursor-pointer rounded-sm hover:bg-white"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
            ...
            <button
              ...
              className="px-5 py-1.5 flex justify-center items-center gap-x-1 bg-red-500 text-white border rounded-sm cursor-pointer hover:bg-white hover:text-red-500 hover:border-red-500"
            >
              {" "}
              <svg
                xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="mx-3 my-10 px-10 pt-5 pb-1 bg-white shadow-lg rounded-sm">
        <div className="my-3 flex justify-start items-center gap-x-3">
          {publicUserObject.profilPicture !== "" ? (
            ...
            <svg
              ...
              stroke-width="1.5"
              stroke="currentColor"
              className="w-10  text-blue-400 rounded-sm hover:text-white"
            >
              <path
                stroke-linecap="round"
                stroke-linejoin="round"
          ...
          <p className="text-[18px]">{post.public_user.Profilname}</p>
        </div>
        <p className="my-3 text-[17px]">{post.text}</p>
        ...
        <p className="mb-3 text-gray-400 text-base text-end">
          {post.timestamp}
        </p>
        <div className="w-full py-5 flex justify-around items-center border border-t-gray-200 border-l-white border-r-white border-b-white">
          <div
          ...
          >
            ...
            <button
              ...
              className="px-2 py-1 bg-blue-400 text-white border border-white rounded-sm cursor-pointer hover:bg-white hover:text-blue-400 hover:border-blue-400"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
            ...
            <button
              ...
              className="px-2 py-1 flex justify-center items-center gap-x-1 bg-red-500 text-white border rounded-sm cursor-pointer hover:bg-white hover:text-red-500 hover:border-red-500"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
          ...
          <div className="flex justify-center items-center gap-x-7">
            <button
              ...
              className="px-2 py-1 flex justify-center items-center gap-x-1 bg-gray-50 border border-gray-200 cursor-pointer rounded-sm hover:bg-white"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
              ...
              <span className="">{likePostCount}</span>
            </button>
            <button
              onClick={() => {
                checkLikeDislikePost(
            ...
            >
              ...
              <span className="">{dislikePostCount}</span>
            </button>
          </div>
          <button
            onClick={() => {
            ...
            className="px-2 py-1 flex justify-center items-center gap-x-1 bg-gray-50 border border-gray-200 rounded-sm hover:bg-white"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
            ...
            <span className="rounded-sm">{commentCount}</span>
          </button>
        </div>
      </div>
    </>
