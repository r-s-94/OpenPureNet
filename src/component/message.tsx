...
export default function Message() {
  ...
  return (
    <section className="message-section h-screen">
      ...
      <h2 className="message-headline mt-3 mb-7 text-center text-3xl">
        Nachrichten
      </h2>

      <div className="message-overview-div w-[40%] h-[48rem] mx-auto px-1 py-1 flex flex-col gap-y-7 overflow-y-scroll  rounded-sm">
        {messageArray.map((message) => {
          return (
            <div className="message-div py-10 flex flex-col items-center justify-center gap-y-10 bg-white shadow-lg border border-gray-200 rounded-sm">
              <div className="message-user-div text-lg flex justify-center items-center gap-x-3">
                {message.public_user.profil_picture !== "" ? (
                  ...
                  <svg
                    ...
                    stroke-width="1.5"
                    stroke="currentColor"
                    className="user-icon w-10 text-blue-500"
                  >
                    <path
                ...
                {message.public_user.profil_name} folgt dir, möchtest du ihm
                auch folgen?
              </div>

              <div className="message-button-div w-[75%] flex justify-around items-center">
                <div className="primary-button-div flex justify-center align-center gap-x-3">
                  <button
                    onClick={() => {
                      checkFollowRequest(message.id, true);
                    }}
                    className="message-follow-true-button px-5 py-2 text-base flex justify-center items-center gap-x-3 bg-blue-500 text-white border border-white rounded-sm cursor-pointer transition-all duration-500 ease-in-out hover:bg-white hover:text-blue-500 hover:border-blue-500"
                  >
                    ja
                  </button>{" "}
                  <button
                    ...
                    className="message-follow-false-button px-5 py-2 text-base text-black flex justify-center items-center gap-x-1 bg-gray-200 border border-gray-300 rounded-sm cursor-pointer transition-all duration-500 ease-in-out hover:bg-white"
                  >
                    nein
                  </button>
                </div>
                ...
                <button
                  ...
                  className="message-show-profil-button px-7 py-2 text-base flex justify-center items-center gap-x-3 bg-white text-blue-500 border border-blue-500 rounded-sm cursor-pointer transition-all duration-500 ease-in-out hover:bg-blue-100"
                >
                  Profil anzeigen
                </button>
              </div>
